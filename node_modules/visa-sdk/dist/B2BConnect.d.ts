...
export declare class B2BConnect extends Visa {
    ...
    addCompany(parameters: B2BConnect.CompanyAddBody): Promise<{
        response: import("request").Response;
        body: any;
    }>;
    editCompany(enterpriseId: string, parameters: B2BConnect.CompanyEditPutBody): Promise<{
        response: import("request").Response;
        body: any;
    }>;
    makePayment(parameters: B2BConnect.PaymentParameters): Promise<{
        response: import("request").Response;
        body: any;
    }>;
...
export declare namespace B2BConnect {
...
//# sourceMappingURL=B2BConnect.d.ts.map